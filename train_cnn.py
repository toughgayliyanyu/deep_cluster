...
parser.add_argument('--data', default='/srv/apps/deepcluster/diary_before_cover_pic',metavar='DIR', help='path to dataset')
...
parser.add_argument('--resume', default='/srv/apps/deepcluster/deepcluster/checkpoint.pth.tar', type=str, metavar='PATH',
                    help='path to checkpoint (default: None)')
parser.add_argument('--checkpoints', type=int, default=25000,
                    help='how many iterations between two checkpoints (default: 25000)')
parser.add_argument('--seed', type=int, default=31, help='random seed (default: 31)')
parser.add_argument('--exp', type=str, default='/srv/apps/deepcluster', help='path to exp folder')
parser.add_argument('--verbose', action='store_true', help='chatty')

class Command(BaseCommand):
    def train_cluster_cnn(self,args):
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            features = self.compute_features(dataloader, model, len(dataset))
            ...
            loss = self.train(train_dataloader, model, criterion, optimizer, epoch)
    ...
    def train(self,args,loader, model, crit, opt, epoch):
        args = parser.parse_args()
        """Training of the CNN.
            Args:
